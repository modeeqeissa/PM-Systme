"""The generated FastAPI schema must match integration-gateway-service/openapi.yaml."""
import os
...
_PROTECTED = [
    ("/integration-configs", "get"),
    ("/integration-configs/{config_id}", "get"),
    ("/integration-configs/{config_id}", "patch"),
    ("/external-system-logs", "get"),
    ("/adapters/{system_name}/call", "post"),
]
