"""FastAPI app factory for community-service.

Phase 1 STUB: health check only. The community_db schema (docs Section 9.3.4) is
...
def create_app() -> FastAPI:
    app = FastAPI(
        ...
        version="0.1-stub",
        description="Phase 1 stub — schema migrated, endpoints pending (FR section 4.4).",
    )
