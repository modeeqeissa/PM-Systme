"""The generated FastAPI schema must match community-service/openapi.yaml.
...
_PROTECTED = [
    ...
    ("/concerns", "post"),
    ("/concerns", "get"),
    ("/concerns/{concern_id}", "get"),
    ("/concerns/{concern_id}", "patch"),
    ("/concerns/{concern_id}/follow-up-actions", "post"),
    ("/concerns/{concern_id}/follow-up-actions", "get"),
    ("/follow-up-actions", "get"),
    ("/follow-up-actions/{follow_up_action_id}", "get"),
    ("/follow-up-actions/{follow_up_action_id}", "patch"),
    ("/follow-up-actions/recompute-status", "post"),
]
