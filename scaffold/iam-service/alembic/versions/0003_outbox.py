"""transactional outbox for iam-service (TD-003)

outbox_events holds domain events written in the same transaction as the admin
action / lockout (SRS §3.4 / §9.4); app.events.relay drains them to Kafka and
audit-service consumes them into audit_logs (FR-IAM-05, FR-IAM-06, FR-AUD-01).
