"""The generated FastAPI schema must match hr-service/openapi.yaml.
...
_PROTECTED = [
    ...
    ("/officers", "post"),
    ("/officers", "get"),
    ("/officers/{officer_id}", "get"),
    ("/officers/{officer_id}", "patch"),
    ("/officers/{officer_id}/assignments", "post"),
    ("/officers/{officer_id}/assignments", "get"),
    ("/officers/{officer_id}/transfers", "post"),
    ("/officers/{officer_id}/transfers", "get"),
    ("/transfers", "get"),
    ("/transfers/{transfer_id}", "patch"),
    ("/officers/{officer_id}/promotions", "post"),
    ("/officers/{officer_id}/promotions", "get"),
    ("/officers/{officer_id}/leave-requests", "post"),
    ("/officers/{officer_id}/leave-requests", "get"),
    ("/leave-requests", "get"),
    ("/leave-requests/{leave_request_id}", "patch"),
    ("/officers/{officer_id}/discipline-records", "post"),
    ("/officers/{officer_id}/discipline-records", "get"),
    ("/discipline-records/{discipline_record_id}", "get"),
    ("/discipline-records/{discipline_record_id}", "patch"),
    ("/discipline-records/{discipline_record_id}", "delete"),
    ("/officers/{officer_id}/performance-reviews", "post"),
    ("/officers/{officer_id}/performance-reviews", "get"),
    ("/performance-reviews/{performance_review_id}", "get"),
    ("/performance-reviews/{performance_review_id}", "patch"),
    ("/performance-reviews/{performance_review_id}", "delete"),
]
