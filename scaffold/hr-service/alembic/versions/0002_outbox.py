"""transactional outbox for hr-service

outbox_events holds domain events written in the same transaction as the HR
write (SRS §3.4 / §9.4); app.events.relay drains them to Kafka and
audit-service consumes them into audit_logs (CLAUDE.md rule 3, FR-AUD-01).
