"""FastAPI app factory for hr-service.

Phase 1 STUB: health check only. The hr_db schema (docs Section 9.3.6) is
...
def create_app() -> FastAPI:
    app = FastAPI(
        ...
        version="0.1-stub",
        description="Phase 1 stub — schema migrated, endpoints pending (FR section 4.6).",
    )
