"""The generated FastAPI schema must match training-service/openapi.yaml.
...
_PROTECTED = [
    ...
    ("/certifications", "post"),
    ("/certifications", "get"),
    ("/certifications/{certification_id}", "get"),
    ("/certifications/{certification_id}", "delete"),
    ("/officer-certifications", "post"),
    ("/officer-certifications", "get"),
    ("/officer-certifications/{officer_certification_id}", "get"),
    ("/officer-certifications/recompute-status", "post"),
]
